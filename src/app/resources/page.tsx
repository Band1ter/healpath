...
export default function ResourcesPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10 pb-16">
      <div className="mb-6">
        <h1 className="font-heading text-3xl font-semibold text-[#f1f5f9] mb-2">
          Free help near you
        </h1>
      ...
      <div className="bg-[#131b2e] border border-[#2a3555] rounded-2xl p-5 mb-6 flex flex-col sm:flex-row gap-4 items-start sm:items-center">
        ...
        <div>
          <p className="text-[#f1f5f9] text-sm font-medium mb-0.5">
      ...
      <Link
        ...
        className="block bg-[#1e0f1a] border border-[#f472b6]/30 hover:border-[#f472b6] rounded-2xl p-5 mb-6 transition-[border-color] duration-150 group"
      >
        <div className="flex items-start gap-3">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#f472b6" className="w-5 h-5 shrink-0 mt-0.5">
              <path d="M11.645 20.91l-.007-.003-.022-.012a15.247 15.247 0 0 1-.383-.218 25.18 25.18 0 0 1-4.244-3.17C4.688 15.36 2.25 12.174 2.25 8.25 2.25 5.322 4.714 3 7.688 3A5.5 5.5 0 0 1 12 5.052 5.5 5.5 0 0 1 16.313 3c2.973 0 5.437 2.322 5.437 5.25 0 3.925-2.438 7.111-4.739 9.256a25.175 25.175 0 0 1-4.244 3.17 15.247 15.247 0 0 1-.383.219l-.022.012-.007.004-.003.001a.752.752 0 0 1-.704 0l-.003-.001Z" />
            </svg>
          <div>
            <p className="text-[#f472b6] text-sm font-semibold mb-1 group-hover:underline">
