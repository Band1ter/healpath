  ...
  return (
    <div className="flex flex-col">
      ...
      <section
        ...
        style={{
          background:
            "radial-gradient(ellipse at 40% 60%, rgba(159,122,234,0.15) 0%, rgba(11,19,38,0) 65%), #0b1326",
        }}
      >
        <p className="text-xs font-medium tracking-[0.15em] text-[#9f7aea] uppercase mb-4">
          About HealPath
        </p>
        <h1 className="font-heading text-4xl sm:text-5xl font-semibold text-[#f1f5f9] mb-4 leading-tight">
          Built for survivors,{" "}
          <span
            style={{
      ...
      <section className="px-4 py-12 bg-[#0b1326]">
        <div className="max-w-2xl mx-auto flex flex-col gap-4">
          {/* Mission */}
          <div className="bg-[#131b2e] border border-[#2a3555] rounded-2xl p-7">
            ...
            <h2 className="font-heading font-semibold text-[#f1f5f9] text-lg mb-2">Our Mission</h2>
          ...
          {/* Privacy First */}
          <div className="bg-[#131b2e] border border-[#2a3555] rounded-2xl p-7">
            <div className="w-10 h-10 bg-[#1c2640] rounded-xl flex items-center justify-center mb-4">
            ...
            <h2 className="font-heading font-semibold text-[#f1f5f9] text-lg mb-2">Privacy First</h2>
            <p className="text-[#94a3b8] text-sm leading-relaxed">
          ...
          {/* Disclaimer */}
          <div className="bg-[#131b2e] border border-[#2a3555] rounded-2xl p-7">
            <div className="w-10 h-10 bg-[#1e1020] rounded-xl flex items-center justify-center mb-4">
            ...
            <h2 className="font-heading font-semibold text-[#f1f5f9] text-lg mb-2">Disclaimer</h2>
            <p className="text-[#94a3b8] text-sm leading-relaxed">
      ...
      {/* Creator section */}
      <section className="bg-[#131b2e] border-y border-[#2a3555] px-4 py-16">
        <div className="max-w-2xl mx-auto text-center">
          <p className="text-xs font-medium tracking-[0.15em] text-[#9f7aea] uppercase mb-4">
            The Creator
          </p>
          <h2 className="font-heading text-2xl font-semibold text-[#f1f5f9] mb-4">
            Rishika Giriraddi
          </h2>
          ...
          <p className="font-heading text-[#c4b5fd] italic text-lg">
      ...
      {/* CTA */}
      <section className="px-4 py-14 text-center bg-[#0b1326]">
        <h3 className="font-heading text-xl text-[#f1f5f9] mb-6">
          Ready to find help?
        </h3>
        <div className="flex flex-wrap gap-4 justify-center">
          <Link
            href="/resources"
            className="px-6 py-3 rounded-2xl text-white font-semibold text-sm hover:opacity-90 transition-opacity"
            style={{ background: "linear-gradient(135deg, #9f7aea, #818cf8)" }}
          >
          ...
          <Link
            href="/chat"
            className="px-6 py-3 rounded-2xl text-[#c4b5fd] font-semibold text-sm border border-[#2a3555] hover:border-[#9f7aea] transition-[border-color] duration-150"
          >
            Talk to Sage →
          </Link>
        </div>
